...
const dbConfig = defineConfig({
  /**
   * Default connection used for all queries. Driven by `DB_CONNECTION` in
   * `.env` (falls back to sqlite for local development).
   */
  ...
  connections: {
    ...
    /**
     * MySQL / MariaDB connection. Selected when `DB_CONNECTION=mysql`.
     */
    mysql: {
      client: 'mysql2',
      connection: {
